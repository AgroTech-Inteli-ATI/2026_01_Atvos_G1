...
> "Bom dia / boa tarde. Somos o Grupo 1 do Módulo 10, parceiros da Atvos. Nesta Sprint 1, entregamos a fundação de dados do projeto: ingestão, limpeza e documentação de 167 mil registros de inventário de talhões."

---

### Slide 2 — Contexto e Fontes

> "Trabalhamos com cinco fontes de dados locais, sem GCP. O coração do projeto são quatro partes do inventário de talhões cobrindo o ciclo 2021-2027, com 74 colunas cada. A quinta fonte é uma tabela de correção de talhões para cruzamentos futuros."

**Pontos a mencionar:**
- 191.025 linhas no total (50k + 50k + 50k + 17k + 23k)
- Granularidade: 1 linha = 1 talhão x 1 safra
...
> "O pipeline tem dois estágios: Bronze (ingestão) e Silver (limpeza). Os scripts em `src/` são modulares, com cada função tendo responsabilidade única."
...
> "Os arquivos Silver estão gerados e documentados. Os inventários cresceram de 74 para 75 colunas com as flags de negócio."
...
| Inventário parte 1 | 50.000 | 74 | 75 | -7 drop, +8 flags, 14.322 imputações |
| Inventário parte 2 | 50.000 | 74 | 75 | -7 drop, +8 flags, 14.210 imputações |
| Inventário parte 3 | 50.000 | 74 | 75 | -7 drop, +8 flags, 14.246 imputações |
| Inventário parte 4 | 17.426 | 74 | 75 | -7 drop, +8 flags, 4.900 imputações |

**Próximos passos (Sprint 2):**
- União dos inventários (partes 1, 2, 3 e 4) por `CHAVESIG`
...
|------|---------|--------|--------------|
| **Rápido** | ~4 min | 1, 4, 5, 6 | Pule slides 2 e 3; mencione o pipeline em uma frase no slide 5 |
| **Normal** | ~5-6 min | Todos | Siga o roteiro acima sem aprofundar exemplos |
| **Detalhado** | ~8-10 min | Todos | Expanda o slide 4 com exemplos de flag; no slide 3, mostre um trecho de código |
