...
> "Bom dia / Boa tarde. Somos o Grupo 1 do Módulo 10, parceiros da Atvos. Nessa Sprint 1 entregamos a fundação de dados do projeto: ingestão, limpeza e documentação de 90 mil registros de inventário de talhões."

---

### Slide 2 — Contexto e Fontes

> "Trabalhamos com três fontes de dados locais — sem GCP. O coração são dois inventários de talhões cobrindo safras 21/22 e 22/23, com 74 colunas cada. A terceira fonte é uma tabela de correção de talhões para cruzamentos futuros."

**Pontos a mencionar:**
- 90.426 linhas no total (50k + 17k + 23k)
...
- União dos inventários (part 2 + part 4) por `CHAVESIG`
